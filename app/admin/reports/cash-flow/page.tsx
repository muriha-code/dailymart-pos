    ...
    <div className="w-full min-h-screen bg-slate-50 p-4 lg:p-6 print:p-0 print:bg-white print:m-0 font-sans text-slate-800">
      <div className="max-w-7xl mx-auto space-y-6 print:max-w-none print:w-full print:m-0 print:space-y-0">
        ...
        <div className="print:hidden space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2.5 self-start sm:self-auto flex-wrap">
              ...
              <button
                ...
                className="bg-[#FFB800] hover:bg-[#FFA800] text-slate-950 font-black text-xs px-4 py-2.5 rounded-xl border-2 border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[1px_1px_0px_0px_rgba(15,23,42,1)] transition-all flex items-center gap-2 cursor-pointer"
              >
                <span>💸</span>
              ...
              <button
                ...
                disabled={isLoading}
                title="Refresh Data"
                className="bg-white hover:bg-slate-100 border-2 border-slate-900 p-2.5 rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] text-slate-900 transition-all cursor-pointer shrink-0 disabled:opacity-50"
              >
          ...
          {/* 2. KPI Financial Metrics Cards (5 Grid Top) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            ...
            <div className="bg-white border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between transition-all">
              ...
              <div className="mt-2">
                ...
                <p className="text-[10px] font-bold text-slate-500 mt-1">Penjualan kotor kasir</p>
              </div>
            </div>
            ...
            <div className="bg-[#F1F5F9] border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between transition-all">
              ...
              <div className="mt-2">
                <h3 className="text-xl font-black font-mono text-slate-700 tracking-tight">
                  {isLoading ? "..." : formatRupiah(reportData?.summary.totalCogs || 0)}
                </h3>
                <p className="text-[10px] font-bold text-slate-500 mt-1">Modal pokok barang</p>
              </div>
            </div>
            ...
            <div className="bg-[#EEF2FF] border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between transition-all">
              ...
              <div className="mt-2">
                <h3 className="text-[#4338CA] font-mono font-black text-xl tracking-tight">
                  {isLoading ? "..." : formatRupiah(reportData?.summary.grossProfit || 0)}
                </h3>
                <p className="text-[10px] font-bold text-[#6366F1] mt-1">Pendapatan - Total HPP</p>
              </div>
            </div>
            ...
            <div className="bg-[#FFE4E6] border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between transition-all">
              ...
              <div className="mt-2">
                <h3 className="text-[#E11D48] font-mono font-black text-xl tracking-tight">
                  {isLoading ? "..." : formatRupiah(reportData?.summary.totalOperatingExpenses || 0)}
                </h3>
                <p className="text-[10px] font-bold text-[#E11D48] mt-1">Gaji, listrik, sewa, WiFi, dll.</p>
              </div>
            </div>

            {/* Card 5 (Laba Bersih Toko) */}
            <div className="bg-[#E8F5E9] border-2 border-slate-900 rounded-xl p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between transition-all sm:col-span-2 lg:col-span-1">
              <span className="text-[10px] font-black uppercase tracking-wider text-slate-700">
                Laba Bersih Toko
              </span>
              <div className="mt-2">
                <h3 className="text-[#065F46] font-mono font-black text-xl tracking-tight">
                  {isLoading
                    ? "..."
                    : formatRupiah(
                ...
                <p className="text-[10px] font-bold text-[#065F46] mt-1">Laba Kotor - Biaya Ops</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-slate-900 rounded-xl p-3 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] flex flex-wrap items-center gap-3 mb-6">
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-black uppercase tracking-wider text-slate-700">Periode:</label>
              <select
                value={periodFilter}
                onChange={(e) => setPeriodFilter(e.target.value)}
                className="bg-slate-50 border-2 border-slate-900 rounded-lg px-3 py-1.5 text-xs font-bold text-slate-900 focus:outline-none focus:bg-white shadow-[1px_1px_0px_0px_rgba(15,23,42,1)] cursor-pointer"
              >
            ...
            {periodFilter === "custom" && (
              <div className="flex items-center gap-2 animate-in fade-in duration-200">
                <input
                  ...
                  className="bg-slate-50 border-2 border-slate-900 rounded-lg px-3 py-1.5 text-xs font-bold text-slate-900 focus:outline-none focus:bg-white shadow-[1px_1px_0px_0px_rgba(15,23,42,1)]"
                />
                <span className="text-xs font-black text-slate-700">s/d</span>
                <input
                  type="date"
                  value={endDate}
            ...
            <div className="flex items-center gap-2">
              <label className="text-xs font-black uppercase tracking-wider text-slate-700">Kategori:</label>
              <select
          ...
          {/* 4. Chart Section (Tren Finansial & Kontribusi Laba) */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                ...
                <div className="flex items-center gap-3 text-xs font-black">
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-3 rounded-sm bg-[#3B82F6] border border-slate-900 inline-block" /> Pendapatan
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-3 rounded-sm bg-[#94A3B8] border border-slate-900 inline-block" /> HPP
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-3 rounded-sm bg-[#10B981] border border-slate-900 inline-block" /> Laba Kotor
                  </span>
                </div>
              </div>
                      ...
                      <Tooltip
                        content={({ active, payload, label }) => {
                          if (active && payload && payload.length) {
                            return (
                              <div className="bg-white text-slate-900 p-3 rounded-xl shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] text-xs space-y-1 border-2 border-slate-900">
            ...
            <div className="lg:col-span-1 bg-white border-2 border-slate-900 rounded-xl p-5 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] flex flex-col justify-between">
              <div>
                <h3 className="text-xs font-black uppercase tracking-wider text-slate-900 mb-1">
                  Kontribusi Laba per Kategori
                </h3>
                <p className="text-[11px] font-semibold text-slate-500">Distribusi proporsi laba kotor</p>
              </div>
                      ...
                      <Tooltip
                        content={({ active, payload }) => {
                          if (active && payload && payload.length) {
                            ...
                            return (
                              <div className="bg-white text-slate-900 p-2.5 rounded-lg shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] text-xs border-2 border-slate-900 font-bold">
                  ...
                  return (
                    <div key={item.name} className="flex items-center justify-between text-xs">
                      <span className="flex items-center gap-2 truncate">
                        ...
                        />
                        <span className="text-slate-800 truncate font-bold text-[11px]">{item.name}</span>
                      </span>
                      <div className="text-right shrink-0">
                        <span className="font-bold font-mono text-slate-900 text-[11px]">{formatRupiah(item.value)}</span>
                        <span className="text-[10px] text-slate-600 ml-1.5 font-mono font-bold">({pct}%)</span>
                      </div>
                    </div>
                  );
                })}
