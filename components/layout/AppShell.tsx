...
function MainLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-slate-100 dark:bg-[#0F172A] text-slate-900 dark:text-slate-100 transition-colors duration-200">
      ...
      <main
        className={`flex-1 min-w-0 flex flex-col h-screen overflow-y-auto bg-slate-100 dark:bg-[#0F172A] text-slate-900 dark:text-slate-100 transition-all duration-300 ease-in-out print:ml-0 print:h-auto print:overflow-visible print:w-full ${
